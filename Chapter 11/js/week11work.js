...
(function(){
    ...
    function setMap(){
        ...
        function callback(data) {
            ...
            setEnumerationUnits(namericaCountries,  map,  path, colorScale, yScaleAdjusted)

            var yScaleAdjusted = yScaleAdjCalc(csvData);
...
function yScaleAdjCalc(csvData){
    var yScaleAdj = d3.scaleLinear()
    .range([463, 0])
    .domain([csvData.min - 10, csvData.max + 10]);
    return yScaleAdj
}
